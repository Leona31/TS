		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '❬❗❭ SÓ O MARIANO PODE USAR ESSE COMANDO JAÉ❬❗❭ ',
					ownerB: '❬❗❭ SÓ O MARIANO PODE USAR ESSE COMANDO JAÉ❬❗❭  ',
					admin: ' ❬ ⚠️ ❭IIIIIIHHH AALA MEMBRO COMUM QUERENDO USAR COMANDO DE ADM, ESSA FOI BOA AKAKAKAKA ❬ ⚠️ ❭ ',
     ...
     case 'cuscuz':
            ...
            break            
                ...
                case 'reportarbug':
                    ...
                    reply('PDP PRÇ, BUG FOI REPORTADO, SE FOR MENTIRA VAI SER COBRADO🙄✌🏼')
                    break
					case 'marcar':
					members_id = []
...
case 'play':   
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'criador':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://pin.it/4FrVlgB`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nome: ༄𝑻𝑰𝑶 𝑴𝑨𝑹𝑰𝑨𝑵𝑶༆☂︎シ︎\n contato: wa.me/+5511970115273\n Nome do bot: TOTO\n status do bot: PAI TA ON BROTA PV KKKKKKKKK'})
					break
                case 'shorturl':
